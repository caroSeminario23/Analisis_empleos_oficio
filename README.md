# *Análisis de la situación de los empleos de oficio - Lima | Perú*
...
![Dashboard final](Dashboard/Dashboard_empleos.jpg)

## 1. Descripción del proyecto
Este proyecto consiste en el análisis de la situación de los empleos de oficio en Lima - Perú a partir de los datos que se encuentran en la web (fuentes confiables tanto nacionales como internacionales). En este repositorio encontrará los archivos relacionados a la generación del  dashboard, mas el detalle lo puede visualizar a través del siguiente [enlace](https://www.notion.so/2-B-squeda-y-an-lisis-de-datos-del-contexto-real-1d8d0fe6d6cb800eb511fb80a463b4be?pvs=4).
